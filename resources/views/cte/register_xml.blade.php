...
<div class="row" id="anime" style="display: none">
	<div class="col s8 offset-s2">
		<lottie-player 
		src="/anime/success.json" background="transparent" speed="0.8"  
		...
		<div class="card">
			<div class="row">
				<div class="col s12">
					...
					<div class="row">
						<div class="col s4">
							<h6>Ultima CT-e: <strong class="red-text">{{$lastCte}}</strong></h6>
						</div>
						<div class="col s4">
				...
				<div class="row">
					<div class="input-field col s4">
						...
						<input autocomplete="off" type="text" value="{{$dadosDaNFe['remetente']}}" name="remetente" id="autocomplete-remetente" class="autocomplete-remetente">
						<label for="autocomplete-remetente">Remetente</label>

						<div class="card" id="info-remetente" style="display: block">
							<div class="row">
								<h5 class="center-align">Remetente</h5>
								<div class="col s12">
									Razao Social: <strong id="nome-remetente" class="red-text">{{$emitente->razao_social}}</strong>
								</div>
								<div class="col s6">
									CNPJ: <strong id="cnpj-remetente" class="red-text">{{$emitente->cpf_cnpj}}</strong>
								</div>
								<div class="col s6">
									IE: <strong id="ie-remetente" class="red-text">{{$emitente->ie_rg}}</strong>
								</div>

								<div class="col s9">
									Rua: <strong id="rua-remetente" class="red-text">{{$emitente->rua}}</strong>
								</div>
								<div class="col s3">
									Nro: <strong id="nro-remetente" class="red-text">{{$emitente->numero}}</strong>
								</div>

								<div class="col s6">
									Bairro: <strong id="bairro-remetente" class="red-text">{{$emitente->bairro}}</strong>
								</div>
								<div class="col s6">
									Cidade: <strong id="cidade-remetente" class="red-text">{{$emitente->cidade->nome}}-{{$emitente->cidade->uf}}</strong>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="input-field col s4 offset-s2">
						...
						<input autocomplete="off" type="text" value="{{$dadosDaNFe['destinatario']}}" name="destinatario" id="autocomplete-destinatario" class="autocomplete-destinatario">
						<label for="autocomplete-destinatario">Destinatário</label>

						<div class="card" id="info-destinatario" style="display: block">
							<div class="row">
								<h5 class="center-align">Destinatário</h5>
								<div class="col s12">
									Razao Social: <strong id="nome-destinatario" class="blue-text">{{$destinatario->razao_social}}</strong>
								</div>
								<div class="col s6">
									CNPJ: <strong id="cnpj-destinatario" class="blue-text">{{$destinatario->cpf_cnpj}}</strong>
								</div>
								<div class="col s6">
									IE: <strong id="ie-destinatario" class="blue-text">{{$destinatario->ie_rg}}</strong>
								</div>
								<div class="col s9">
									Rua: <strong id="rua-destinatario" class="blue-text">{{$destinatario->rua}}</strong>
								</div>
								<div class="col s3">
									Nro: <strong id="nro-destinatario" class="blue-text">{{$destinatario->numero}}</strong>
								</div>

								<div class="col s6">
									Bairro: <strong id="bairro-destinatario" class="blue-text">{{$destinatario->bairro}}</strong>
								</div>
								<div class="col s6">
									Cidade: <strong id="cidade-destinatario" class="blue-text">{{$destinatario->cidade->nome}}-{{$destinatario->cidade->uf}}</strong>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="card-content">
									...
									<div class="row">
										<div class="input-field col s8">
											...
											<input autocomplete="off" type="text" value="{{$dadosDaNFe['chave']}}" id="chave_nfe">
				...
				<div id="itens" class="col s12">
					<div class="card">
						<div class="row">
							...
							<div class="col s12">
								<div class="input-field col s4">
									<input autocomplete="off" type="text" value="{{$dadosDaNFe['produto_predominante']}}" name="prod_predominante" id="prod_predominante" class="prod_predominante type-ref">
							...
							<div class="col s12">
								<div class="input-field col s3">
									<input autocomplete="off" type="text" value="{{$dadosDaNFe['valor_carga']}}"  id="valor_carga" class="valor_carga">
							...
							<div class="row">
								<div class="col s12">
									...
									<div class="col s2 input-field">
										<input type="text" value="{{$dadosDaNFe['quantidade']}}" id="quantidade_carga">
							...
							<div class="row">
								<div class="col s12">
									...
									<div class="input-field col s3">
										<input type="text" data-length="20" value="{{$dadosDaNFe['componente']}}" id="nome_componente">
										<label>Nome do Componente</label>
									</div>

									<div class="col s2 input-field">
										<input type="text" value="{{$dadosDaNFe['valor_frete']}}" id="valor_componente">
					...
					<div class="card">
						...
						<div class="row">
							...
							<div class="col s12">
								...
								<div class="input-field col s3">
									<input autocomplete="off" value="{{$dadosDaNFe['valor_frete']}}" type="text" id="valor_transporte" class="valor_transporte type-ref">
									<label for="valor_transporte">Valor da Prestação de Serviço</label>
								</div>
								<div class="input-field col s3">
									<input autocomplete="off" value="{{$dadosDaNFe['valor_frete']}}" type="text" id="valor_receber" class="valor_receber type-ref">
						...
						<div class="row">
							<div class="col s12">
								<div class="col s3 input-field">
									<input autocomplete="off" type="text" name="cidade_envio" id="autocomplete-cidade-envio" value="{{$dadosDaNFe['munipio_envio']}}" class="autocomplete-cidade-envio type-ref">
									<label>Municipio de Envio</label>
								</div>
								<div class="col s3 input-field">
									<input autocomplete="off" type="text" name="cidade_inicio" id="autocomplete-cidade-inicio" value="{{$dadosDaNFe['munipio_envio']}}" class="autocomplete-cidade-inicio type-ref">
									<label>Municipio de Inicio</label>
								</div>
								<div class="col s3 input-field">
									<input autocomplete="off" type="text" name="cidade_fim" id="autocomplete-cidade-final" value="{{$dadosDaNFe['munipio_final']}}" class="autocomplete-cidade-final type-ref">
